...
class ToolSeq_Pivot(QWidget):
	...
	def __init__(self):
		super(ToolSeq_Pivot, self).__init__(ToolSeq_Pivot.windowMain)

		self.window = ToolSeq_Pivot.qUiLoader.load(ToolSeq_Pivot.userScriptDir + 'ui/ToolSeq_Pivot.ui', self)
		...
		with open(ToolSeq_Pivot.userScriptDir + 'ToolSeq.qss') as fileStyleSheet:
