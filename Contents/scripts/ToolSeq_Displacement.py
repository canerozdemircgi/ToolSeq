...
class ToolSeq_Displacement(QWidget):
	...
	def __init__(self):
		...
		self.window = ToolSeq_Displacement.qUiLoader.load(ToolSeq_Displacement.userScriptDir + 'ToolSeq_Displacement.ui', self)
		...
		with open(ToolSeq_Displacement.userScriptDir + 'ToolSeq.qss', 'r') as fileStyleSheet:
